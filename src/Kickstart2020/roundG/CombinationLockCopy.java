...
public class CombinationLockCopy {

    public static void main(String[] arg) throws Exception {
            long[] a = new long[] {2, 4};
            long n = 5;
//            long mirror = getMirror(2, 5);
//        System.out.println(mirror);
//        int m1 = getIndexOfRightMirror(mirror, a);
//        System.out.println(m1);
            long minSteps = getMinStep(a, n);

        System.out.println(minSteps);

    }

    public static long getMinStep(long[] a, long n){
        Arrays.sort(a);
        int w = a.length;
        long[] S = new long[w];
        S[0] = a[0];
